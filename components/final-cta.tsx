      ...
      <div className="mx-auto max-w-5xl">
        <AnimateIn>
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg text-background/55 max-w-lg">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-start gap-3">
              <Button
                size="lg"
                className="bg-background text-foreground hover:bg-background/90 active:scale-[0.98] px-7 py-5 text-sm font-semibold rounded-lg transition-all duration-150"
              >
